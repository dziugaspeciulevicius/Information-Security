...
**Decryption** - To decrypt text a key is needed which was entered during text encryption. Ouputs correct information, but also shows a BadPaddingException if other information is also being stored in the database.
